<!--begin::Table-->
<table class="table erp-datatable align-middle table-bordered fs-6 gy-5 m-auto display responsive" id="customerListDatatable">
    <thead>
        <tr class="text-start text-muted fw-bolder fs-7 text-uppercase gs-0" style="background: #fff;">
            ...
            <th class="min-w-60px  fw-bold text-dark">{{ __('Gender') }}</th>
...
$(document).ready(function () {
    ...
    var table = $('#customerListDatatable').DataTable({
        ...
        columns: [
            ...
            { data: 'area',         name: 'area.name',  orderable: false, searchable: false },
    ...
    $(document).on('click', '.btn-view', function (e) {
        ...
        $.ajax({
            ...
            success: function (response) {
                ...
                window.renderCustomerViewModal(response.data);
            },
    ...
    $(document).on('click', '.status-toggle', function () {
        ...
        $.ajax({
            ...
            success: function (res) {
                ...
                $('#customerListDatatable').DataTable().ajax.reload(null, false);
            },
    ...
    $(document).on('click', '.btn-delete', function (e) {
        ...
        function performDelete() {
            $.ajax({
                ...
                success: function (response) {
                    toastr.success(response.message || '{{ __('Customer deleted.') }}');
                    $('#customerListDatatable').DataTable().ajax.reload(null, false);
                },

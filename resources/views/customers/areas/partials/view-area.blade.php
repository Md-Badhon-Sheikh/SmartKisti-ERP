    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title">{{ __('Area Details') }}</h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <div class="modal-body" id="areaViewModalBody"></div>
...
@push('scripts')
<script>
    window.renderAreaViewModal = function (data) {
        ...
        const html = ''
            ...
            + '</div>'
            + '<div class="row mb-4">'
            +   '<label class="col-5 fw-bold text-muted">{{ __('Customers') }}</label>'
            +   '<div class="col-7">' + data.customers_count + '</div>'
            + '</div>'
            + '<div class="row">'

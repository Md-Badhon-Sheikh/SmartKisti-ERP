<!--begin::Table-->
<table class="table erp-datatable align-middle table-bordered fs-6 gy-5 m-auto display responsive" id="receiptListDatatable">
    <thead>
...
$(document).ready(function () {
    $('#receiptListDatatable').DataTable({
        processing: true,
        serverSide: true,
        ajax: {
            url:  "{{ route('receipts.datatable') }}",
            type: 'GET'
        },
        columns: [
            {
